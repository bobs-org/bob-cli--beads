...
| [bob-cli-1z.2](bob-cli-1z.2.md) | Pure toggle planners for the route note and the daily ledger | ◐ in_progress | medium | 2026-09-10 | 0 | 0 |
| [bob-cli-1z.3](bob-cli-1z.3.md) | Wire the toggle into bob capture, its JSON contract, and its human output | ◐ in_progress | medium | 2026-09-10 | 0 | 0 |
...
flowchart TD
    ...
    n2["bob-cli-1z.2: Pure toggle planners for the route note and the daily ledger [in_progress]"]
