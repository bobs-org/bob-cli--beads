...
| [bob-cli-1t.2](bob-cli-1t.2.md) | \`@route:id#pomodoro\` grammar and capture execution | ◐ in_progress | medium | 2026-08-28 | 1 | 0 |
| [bob-cli-1t.3](bob-cli-1t.3.md) | \`bob capture-pomodoro-name\` write command | ◐ in_progress | medium | 2026-08-28 | 1 | 0 |
...
flowchart TD
    ...
    n2["bob-cli-1t.2: `@route:id#pomodoro` grammar and capture execution [in_progress]"]
    n3["bob-cli-1t.3: `bob capture-pomodoro-name` write command [in_progress]"]
...
| [bbugyi200.athena.bob-cli-1t.2](https://github.com/bobs-org/bob-cli--agents/blob/main/agents/bbugyi200.athena.bob-cli-1t.2/README.md) | [bob-cli-1t.2](bob-cli-1t.2.md) | 0 |
