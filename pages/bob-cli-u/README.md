...
| [bob-cli-u.2](bob-cli-u.2.md) | Beautiful stateful macOS selection and prompt | ◐ in_progress | medium | 2026-08-15 | 1 | 0 |
...
flowchart TD
    ...
    n2["bob-cli-u.2: Beautiful stateful macOS selection and prompt [in_progress]"]
    n0 --> n1
    n0 --> n2
    n1 -.-> n2
```
