...
| [bob-cli-m.2](bob-cli-m.2.md) | Native bullet editing and hierarchical preview | ◐ in_progress | medium | 2026-08-14 | 1 | 0 |
...
flowchart TD
    ...
    n2["bob-cli-m.2: Native bullet editing and hierarchical preview [in_progress]"]
    n0 --> n1
    n0 --> n2
    n1 -.-> n2
```
...
| [bbugyi200.athena.bob-cli-m.2](https://github.com/bobs-org/bob-cli--agents/blob/main/agents/bbugyi200.athena.bob-cli-m.2/README.md) | [bob-cli-m.2](bob-cli-m.2.md) | 0 |
