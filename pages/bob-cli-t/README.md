...
flowchart TD
    ...
    n6["bob-cli-t.4.2: Integrate later-item task-ID assignment with batch capture [in_progress]"]
...
| [bbugyi200.athena.bob-cli-t.4.2](https://github.com/bobs-org/bob-cli--agents/blob/main/agents/bbugyi200.athena.bob-cli-t.4.2/README.md) | [bob-cli-t.4.2](bob-cli-t.4.2.md) | 0 |
